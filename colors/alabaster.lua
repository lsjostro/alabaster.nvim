...
if vim.o.background == "dark" then
	...
	theme = {
		...
		Title = { fg = const_fg },
		Visual = { bg = nord.bright_blue },
		VisualNOS = { bg = nord.bright_blue },
		...
		DiagnosticError = { fg = error, bg = nord.bg },
		DiagnosticWarn = { fg = warn, bg = nord.bg },
		DiagnosticHint = { fg = hint, bg = nord.bg },
		DiagnosticInfo = { fg = info, bg = nord.bg },
